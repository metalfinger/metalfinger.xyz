...
function onezero(timing) {
    ...
    for (var i = 0; i < 1000; i += 1) {
        ...
        {
            var target = {
                x: Math.sin(angle) * magicalNumberX * 2.1,
                y: 0,
                z: Math.cos(angle) * magicalNumberY * 2.1,
                rx: 0,
                ry: 0,
                rz: 0,
                sx: barSize * 6,
            ...
            var target = {
                x: 0,
                y: Math.sin(angle) * magicalNumberX * 2.1,
                z: Math.cos(angle) * magicalNumberY * 2.1,
                rx: 0,
                ry: 0,
                rz: 0,
            ...
            var target = {
                x: Math.cos(angle) * magicalNumberY * 2.1,
                y: Math.sin(angle) * magicalNumberX * 2.1,
                z: 0,
                rx: 0,
                ry: 0,
    ...
    for (var i = 0; i < 360; i += 8) {
        for (var j = 0; j < 180; j += 9) {
            ...
            if (alternator) {
                ...
                alternator = true;
                var target = {
                    x: (magicalNumberX * 0.5) * Math.sin(iAngle) * Math.sin(jAngle),
